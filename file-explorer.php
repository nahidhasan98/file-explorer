    ...
    <div class="content">
        ...
        <table class="feTable">
            ...
            foreach ($myFilesSorted as $myFile) {
                ...
                echo '<td>';
                if ($myFile->name != "..")
                    echo '<span><img src="./assets/images/delete.png" alt="delete" srcset="" title="Delete" class="icon iconDelete"></span>';

                // download icon
                if (!$myFile->isDir())
                    echo '<span><img src="./assets/images/download.png" alt="download" srcset="" title="Download" class="icon iconDownload"></span>';

                // rename icon
                if ($myFile->name != "..")
                    echo '<span><img src="./assets/images/rename.png" alt="Rename" srcset="" title="Rename" class="icon iconRename"></span>';
